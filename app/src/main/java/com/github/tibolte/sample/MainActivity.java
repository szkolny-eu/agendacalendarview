...
public class MainActivity extends AppCompatActivity implements CalendarPickerController {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        mAgendaCalendarView.init(Locale.getDefault(), readyWeeks,readyDays,readyEvents,this, new DrawableEventRenderer());
    ...
    private void mockList(List<CalendarEvent> eventList) {
        ...
        BaseCalendarEvent event2 = new BaseCalendarEvent(
                "Visit to Dalvík",
        ...
        DrawableCalendarEvent event3 = new DrawableCalendarEvent(
                "Visit of Harpa",
                "",
                "Dalvík",
